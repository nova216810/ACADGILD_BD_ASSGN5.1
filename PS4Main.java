...
public static void main(String[] args) throws Exception 
{
   	Configuration conf = new Configuration();
		...
		job.setJarByClass(PS4Main.class);
		job.setMapperClass(PS4Mapper.class);
		job.setPartitionerClass(PS4Partitioner.class);
		job.setReducerClass(PS4Reducer.class); 
